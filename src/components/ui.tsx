...
export function SectionHeading({ index, kicker, title }: { index: string; kicker: string; title: ReactNode }) {
  return (
...
// Tracks the pointer so the .spotlight glow follows it.
